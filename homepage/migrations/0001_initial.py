    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timeAdded', models.DateTimeField(verbose_name=django.utils.timezone.now)),
                ('farmOwner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='homepage.FarmOwner')),
            ],
        ),
        migrations.CreateModel(
            name='Animal',
            fields=[
                ...
                ('timeAdded', models.DateTimeField(verbose_name=django.utils.timezone.now)),
                ('farmId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='homepage.FarmLocation')),
                ('ownderId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='homepage.FarmOwner')),
            ],
        ),
    ]
